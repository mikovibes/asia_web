    ...
    <div ref={containerRef} className="w-full bg-[#FAFAFA] text-beo-black py-32 relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        ...
        <div className="flex justify-between items-end mb-32">
          <h2 className="font-nunito font-black text-8xl md:text-[12rem] leading-none tracking-tighter uppercase">Menu</h2>
        ...
        <div className="flex flex-col gap-32">
          {menuData.map((category, idx) => (
            <div 
              ...
              className="relative w-full grid grid-cols-1 lg:grid-cols-12 gap-12"
            >
